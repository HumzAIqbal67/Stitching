...
def compute_translation(matches, kp1, kp2):
    ...
    translation[0] = 0  # Assume translation only in the y-axis
...
def main():
    ...
    for i in range(len(images) - 1):
        ...
        translation, matches = compute_translation(matches, keypoints_and_descriptors[i][0], keypoints_and_descriptors[i + 1][0])
