...
class VideoApp:
    def __init__(self, root, video_path, crop_params=None):
        ...
        # Parameters for Lucas-Kanade optical flow $ winSize more comp expensive but better for larger windows
            ...
            if ret:
                ...
                if self.prev_gray is None:
                    ...
                    if p1 is not None and st is not None:
                        ...
                        # If optical flow calculation fails, reinitialize the features
                        self.prev_gray = gray
                        self.p0 = cv2.goodFeaturesToTrack(gray, mask=None, **self.feature_params)
